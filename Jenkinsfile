pipeline {
    agent any
    environment {
        DOCKER_IMAGE = "annishasaravanan/docker-app:latest"  // Change this to your registry
        ...
        stage('Checkout Code') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'github', usernameVariable: 'GIT_USER', passwordVariable: 'GIT_TOKEN')]) {
                    git url: "https://$GIT_USER:$GIT_TOKEN@github.com/annishasaravanan/Docker.git", branch: 'main'
                }
            }
        }
